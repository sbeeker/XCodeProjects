...
class UserTableViewController: UITableViewController, UINavigationControllerDelegate, UIImagePickerControllerDelegate {
  ...
  func checkForMessage() {
    ...
    if PFUser.currentUser() != nil {
      ...
      query.whereKey("recipientUsername", equalTo: username)
              ...
              imageView.loadInBackground({
                ...
                if error == nil {
                  ...
                  alert.addAction(UIAlertAction(title: "OK", style: UIAlertActionStyle.Default, handler: {
                    ...
                    do { try pfObjects[0].delete() } catch {}
  ...
  override func viewDidLoad() {
    ...
    let users = query.findObjectsInBackgroundWithBlock({ (users, error) in
      if error == nil {
